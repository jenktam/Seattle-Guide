...
const marker = L.marker([47.620506, -122.349277]).bindPopup(`<b>Space Needle</b><br>The Space Needle is an observation tower in Seattle, Washington, a landmark of the Pacific Northwest, and an icon of Seattle. It was built in the Seattle Center for the 1962 World's Fair, which drew over 2.3 million visitors, when nearly 20,000 people a day used its elevators.`)
.openPopup()
.addTo(map)
